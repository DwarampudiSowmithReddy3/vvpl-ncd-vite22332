...
from app.models.pydantic.models import LoginRequest, LoginResponse, UserResponse, Token, UserInDB
...
# DISABLED: This endpoint was causing false "Session End" logs on page refresh and navigation
# Session tracking should be handled by backend timeout, not frontend page unload events
...
#     DISABLED: Causes false session end logs
#     """
#     try:
#         db = get_db()
#         
