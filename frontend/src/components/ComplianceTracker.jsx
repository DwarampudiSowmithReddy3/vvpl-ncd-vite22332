...
const ComplianceTracker = ({ onClose, seriesData = null }) => {
  ...
  const handleDocumentSubmit = (e) => {
    ...
    addAuditLog({
      ...
      adminName: user ? user.name : 'Admin',
      adminRole: user ? user.displayRole : 'Admin',
      details: `Uploaded compliance document "${documentForm.title}" for series "${seriesData?.seriesName || 'Series A NCD'}" (Category: ${documentForm.category})`,
      ...
      changes: {
        ...
        legalReference: documentForm.legalReference,
        seriesName: seriesData?.seriesName || 'Series A NCD',
