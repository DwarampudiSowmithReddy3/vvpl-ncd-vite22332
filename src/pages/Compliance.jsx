...
const Compliance = () => {
  ...
  const complianceSeries = [
    ...
    { id: 'comp-1', name: 'Series A NCD', interestRate: 8.5, interestFrequency: 'Quarterly', investors: 45, fundsRaised: 25000000, targetAmount: 100000000, issueDate: '2024-01-15', maturityDate: '2027-01-15', lastUpdated: '2024-01-08', status: 'yet-to-be-submitted' },
    { id: 'comp-2', name: 'Series B NCD', interestRate: 9.0, interestFrequency: 'Half-Yearly', investors: 32, fundsRaised: 18000000, targetAmount: 75000000, issueDate: '2024-02-01', maturityDate: '2027-02-01', lastUpdated: '2024-01-07', status: 'yet-to-be-submitted' },
    { id: 'comp-3', name: 'Series D NCD', interestRate: 8.75, interestFrequency: 'Annually', investors: 28, fundsRaised: 15000000, targetAmount: 60000000, issueDate: '2024-03-10', maturityDate: '2027-03-10', lastUpdated: '2024-01-06', status: 'yet-to-be-submitted' },
    { id: 'comp-4', name: 'Series E NCD', interestRate: 9.25, interestFrequency: 'Quarterly', investors: 38, fundsRaised: 22000000, targetAmount: 80000000, issueDate: '2024-04-05', maturityDate: '2027-04-05', lastUpdated: '2024-01-05', status: 'yet-to-be-submitted' },
    
    // Pending (4 series)
    { id: 'comp-5', name: 'Series F NCD', interestRate: 8.8, interestFrequency: 'Half-Yearly', investors: 52, fundsRaised: 45000000, targetAmount: 90000000, issueDate: '2024-01-20', maturityDate: '2027-01-20', lastUpdated: '2024-01-04', status: 'pending' },
    { id: 'comp-6', name: 'Series G NCD', interestRate: 9.1, interestFrequency: 'Quarterly', investors: 41, fundsRaised: 35000000, targetAmount: 70000000, issueDate: '2024-02-15', maturityDate: '2027-02-15', lastUpdated: '2024-01-03', status: 'pending' },
    { id: 'comp-7', name: 'Series H NCD', interestRate: 8.9, interestFrequency: 'Annually', investors: 47, fundsRaised: 40000000, targetAmount: 85000000, issueDate: '2024-03-01', maturityDate: '2027-03-01', lastUpdated: '2024-01-02', status: 'pending' },
    { id: 'comp-8', name: 'Series I NCD', interestRate: 9.3, interestFrequency: 'Half-Yearly', investors: 36, fundsRaised: 30000000, targetAmount: 65000000, issueDate: '2024-04-12', maturityDate: '2027-04-12', lastUpdated: '2024-01-01', status: 'pending' },
    
    // Submitted (4 series)
    { id: 'comp-9', name: 'Series J NCD', interestRate: 8.6, interestFrequency: 'Quarterly', investors: 65, fundsRaised: 85000000, targetAmount: 100000000, issueDate: '2024-01-10', maturityDate: '2027-01-10', lastUpdated: '2023-12-31', status: 'submitted' },
    { id: 'comp-10', name: 'Series K NCD', interestRate: 9.2, interestFrequency: 'Half-Yearly', investors: 58, fundsRaised: 70000000, targetAmount: 90000000, issueDate: '2024-02-08', maturityDate: '2027-02-08', lastUpdated: '2023-12-30', status: 'submitted' },
    { id: 'comp-11', name: 'Series L NCD', interestRate: 8.95, interestFrequency: 'Annually', investors: 72, fundsRaised: 95000000, targetAmount: 120000000, issueDate: '2024-03-05', maturityDate: '2027-03-05', lastUpdated: '2023-12-29', status: 'submitted' },
    { id: 'comp-12', name: 'Series M NCD', interestRate: 9.4, interestFrequency: 'Quarterly', investors: 61, fundsRaised: 80000000, targetAmount: 110000000, issueDate: '2024-04-18', maturityDate: '2027-04-18', lastUpdated: '2023-12-28', status: 'submitted' }
  ];
